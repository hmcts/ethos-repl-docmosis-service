...
import static uk.gov.hmcts.ecm.compat.common.helpers.ESHelper.LISTING_ABERDEEN_VENUE_FIELD_NAME;
import static uk.gov.hmcts.ecm.compat.common.helpers.ESHelper.LISTING_DUNDEE_VENUE_FIELD_NAME;
import static uk.gov.hmcts.ecm.compat.common.helpers.ESHelper.LISTING_EDINBURGH_VENUE_FIELD_NAME;
import static uk.gov.hmcts.ecm.compat.common.helpers.ESHelper.LISTING_GLASGOW_VENUE_FIELD_NAME;
...
import static uk.gov.hmcts.ecm.compat.common.model.helper.Constants.LISTINGS;
import static uk.gov.hmcts.ecm.compat.common.model.helper.Constants.LISTINGS_DEV;
import static uk.gov.hmcts.ecm.compat.common.model.helper.Constants.LISTINGS_USER;
...
import static uk.gov.hmcts.ecm.compat.common.model.helper.Constants.NEW_DATE_PATTERN;
import static uk.gov.hmcts.ecm.compat.common.model.helper.Constants.NEW_LINE;
import static uk.gov.hmcts.ecm.compat.common.model.helper.Constants.NEW_TIME_PATTERN;
...
public class ListingHelper {
    ...
    private static final String ITCO_REGEX = "\\d+_";
    ...
    private static String getHearingJudgeName(HearingType hearingType) {
        ...
        if (!isNullOrEmpty(hearingType.getJudge())) {
            ...
            if (!isNullOrEmpty(hearingType.getAdditionalJudge())) {
                judgeName = hearingType.getJudge() + " & " + hearingType.getAdditionalJudge();
            }
        }
    ...
    private static String getOfficeName(String caseType) {
        ...
        if (index != 0) {
            ...
            return caseType.replace(upperCaseLetter, SPACE + upperCaseLetter);
        } else {
            return caseType;
        }
    }
    ...
    public static String getVenueFromDateListedType(DateListedType dateListedType) {
        ...
        switch (dateListedType.getHearingVenueDay()) {
            case GLASGOW_OFFICE:
                return dateListedType.getHearingGlasgow() != null ? dateListedType.getHearingGlasgow() : SPACE;
            case DUNDEE_OFFICE:
                return dateListedType.getHearingDundee() != null ? dateListedType.getHearingDundee() : SPACE;
            case EDINBURGH_OFFICE:
                return dateListedType.getHearingEdinburgh() != null ? dateListedType.getHearingEdinburgh() : SPACE;
            case ABERDEEN_OFFICE:
                return dateListedType.getHearingAberdeen() != null ? dateListedType.getHearingAberdeen() : SPACE;
            case NEWCASTLE_CFT:
                return NEWCASTLE_CFCTC;
            case TEESSIDE_MAGS:
                return TEESSIDE_JUSTICE_CENTRE;
            default:
                return dateListedType.getHearingVenueDay() != null ? dateListedType.getHearingVenueDay() : SPACE;
        }
    }
