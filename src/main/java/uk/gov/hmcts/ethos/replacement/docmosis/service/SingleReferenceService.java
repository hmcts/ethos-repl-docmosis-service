...
public class SingleReferenceService {
    ...
    private String generateOfficeReference(SingleRefRepository referenceRepository, String currentYear, int numberCases,
                                           String officeNumber, String officeName) {
        return officeNumber + referenceRepository.ethosCaseRefGen(numberCases, Integer.parseInt(currentYear), officeName);
    }
