...
public class RespondentRepresentativeDynamicList {

    private RespondentRepresentativeDynamicList() {
    }
            ...
            if (caseData.getRepCollection() != null && !caseData.getRepCollection().isEmpty()) {
                ...
                while (repItr.hasNext()) {
                    ...
                    if (respRepCollection.getValue().getDynamicRespRepName() == null) {
                        ...
                        dynamicValueType = DynamicListHelper.getDynamicValue(respRepCollection.getValue().getRespRepName());
                    } else {
