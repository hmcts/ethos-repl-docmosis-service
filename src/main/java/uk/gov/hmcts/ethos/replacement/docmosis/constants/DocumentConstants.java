...
public class DocumentConstants {
    ...
    public static final String APP_TO_STRIKE_OUT_ALL_OR_PART_OF_THE_CLAIM = "App to Strike out all or part of the "
            + "claim";
    public static final String APP_TO_STRIKE_OUT_ALL_OR_PART_OF_THE_RESPONSE = "App to Strike out all or part of the "
            + "response";
