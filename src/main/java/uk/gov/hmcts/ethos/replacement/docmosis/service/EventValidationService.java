...
public class EventValidationService {
    ...
    public List<String> validateAndSetRespRepNames(uk.gov.hmcts.ecm.common.model.ccd.CaseData caseData) {
        ...
        if (CollectionUtils.isNotEmpty(caseData.getRespondentCollection())
            ...
            List<uk.gov.hmcts.ecm.common.model.ccd.items.RepresentedTypeRItem> repCollection = caseData.getRepCollection();
            List<uk.gov.hmcts.ecm.common.model.ccd.items.RepresentedTypeRItem> updatedRepList = new ArrayList<>();
