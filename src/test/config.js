module.exports = {
    ...
    IdamBaseUrl: process.env.IDAMBASE_URL || 'https://idam-api.aat.platform.hmcts.net',
    RedirectUri: process.env.REDIRECTURI || `https://manage-case.aat.platform.hmcts.net/oauth2/callback`,
