module.exports = {
    ...
    S2SProvider: process.env.S2S_PROVIDER || 'http://rpe-service-auth-provider-aat.platform.hmcts.net',
    CCDDataStoreApi: process.env.CCD_DATA_STORE_API_URL || 'http://ccd-data-store-api-aat.platform.hmcts.net',
