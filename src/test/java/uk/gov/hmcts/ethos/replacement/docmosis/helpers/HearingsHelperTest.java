...
public class HearingsHelperTest {
    ...
    public void validateHearingDatesInPastTest() {
        ...
        caseData.getHearingsCollectionForUpdate().getFirst().getValue().getHearingDateCollection()
                .getFirst().getValue().setHearingTimingBreak("2021-12-19T10:05:00");
        caseData.getHearingsCollectionForUpdate().getFirst().getValue().getHearingDateCollection()
                .getFirst().getValue().setHearingTimingResume("2021-12-19T10:06:00");
        caseData.getHearingsCollectionForUpdate().getFirst().getValue().getHearingDateCollection()
    ...
    public void invalidateHearingDatesInFutureTest() {
        ...
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue().setHearingTimingBreak("2222-11-01T12:11:05.000");
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue().setHearingTimingResume("2222-11-01T12:11:10.000");
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
    ...
    @Test
    public void validateBreakTime_equalToStart_addsBreakTimeValidationErrorOnly() {
        setValidHearingStartFinishTimes();
        // break equal to start
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingBreak("2019-11-01T12:11:00.000");
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingResume("2019-11-01T12:11:10.000");

        List<String> errors = hearingTimeValidation(caseData);
        String hearingNumber = caseData.getHearingsCollectionForUpdate().getFirst().getValue().getHearingNumber();
        assertEquals(1, errors.size());
        assertEquals(String.format(BREAK_TIME_VALIDATION_MESSAGE, hearingNumber), errors.getFirst());
    }

    @Test
    public void validateBreakTime_afterResume_addsBothBreakAndResumeErrors() {
        setValidHearingStartFinishTimes();
        // break after resume
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingBreak("2019-11-01T12:11:15.000");
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingResume("2019-11-01T12:11:10.000");
        ...
        String hearingNumber = caseData.getHearingsCollectionForUpdate().getFirst().getValue().getHearingNumber();
        assertEquals(2, errors.size());
        assertTrue(errors.contains(String.format(BREAK_TIME_VALIDATION_MESSAGE, hearingNumber)));
        assertTrue(errors.contains(String.format(RESUME_TIME_VALIDATION_MESSAGE, hearingNumber)));
    }

    @Test
    public void validateResumeTime_equalToFinish_addsResumeTimeValidationErrorOnly() {
        setValidHearingStartFinishTimes();
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingBreak("2019-11-01T12:11:10.000");
        // resume equal to finish
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingResume("2019-11-01T12:11:20.000");

        List<String> errors = hearingTimeValidation(caseData);
        String hearingNumber = caseData.getHearingsCollectionForUpdate().getFirst().getValue().getHearingNumber();
        assertEquals(1, errors.size());
        assertEquals(String.format(RESUME_TIME_VALIDATION_MESSAGE, hearingNumber), errors.getFirst());
    }

    @Test
    public void validateBreakTime_beforeStart_addsBreakTimeValidationErrorOnly() {
        setValidHearingStartFinishTimes();
        // break before start
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingBreak("2019-11-01T12:10:59.000");
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingResume("2019-11-01T12:11:10.000");
    ...
    @Test
    public void validateResumeTime_afterFinish_addsResumeTimeValidationErrorOnly() {
        setValidHearingStartFinishTimes();
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingBreak("2019-11-01T12:11:10.000");
        ...
        caseData.getHearingsCollectionForUpdate().getFirst().getValue()
                .getHearingDateCollection().getFirst().getValue()
                .setHearingTimingResume("2019-11-01T12:11:21.000");
