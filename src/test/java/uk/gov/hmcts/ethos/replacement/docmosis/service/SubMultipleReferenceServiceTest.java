...
public class SubMultipleReferenceServiceTest {
    ...
    public void createManchesterReference() {
        when(subMultipleRefManchesterRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(previousReferenceManchester);
    ...
    public void createScotlandReference() {
        when(subMultipleRefScotlandRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(previousReferenceScotland);
    ...
    public void createLeedsReference() {
        when(subMultipleRefLeedsRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceLeeds);
    ...
    public void createMidlandsWestReference() {
        when(subMultipleRefMidlandsWestRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceMidlandsWest);
    ...
    public void createMidlandsEastReference() {
        when(subMultipleRefMidlandsEastRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceMidlandsEast);
    ...
    public void createBristolReference() {
        when(subMultipleRefBristolRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceBristol);
    ...
    public void createWalesReference() {
        when(subMultipleRefWalesRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceWales);
    ...
    public void createNewcastleReference() {
        when(subMultipleRefNewcastleRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceNewcastle);
    ...
    public void createWatfordReference() {
        when(subMultipleRefWatfordRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceWatford);
    ...
    public void createLondonCentralReference() {
        when(subMultipleRefLondonCentralRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceLondonCentral);
    ...
    public void createLondonSouthReference() {
        when(subMultipleRefLondonSouthRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceLondonSouth);
    ...
    public void createLondonEastReference() {
        when(subMultipleRefLondonEastRepository.findTopByOrderByMultipleRefAndRefDesc()).thenReturn(referenceLondonEast);
