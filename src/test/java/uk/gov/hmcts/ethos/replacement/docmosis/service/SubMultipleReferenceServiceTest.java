...
public class SubMultipleReferenceServiceTest {
    ...
    public void createManchesterReference() {
        when(subMultipleRefManchesterRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(previousReferenceManchester);
    ...
    public void createScotlandReference() {
        when(subMultipleRefScotlandRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(previousReferenceScotland);
    ...
    public void createLeedsReference() {
        when(subMultipleRefLeedsRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceLeeds);
    ...
    public void createMidlandsWestReference() {
        when(subMultipleRefMidlandsWestRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceMidlandsWest);
    ...
    public void createMidlandsEastReference() {
        when(subMultipleRefMidlandsEastRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceMidlandsEast);
    ...
    public void createBristolReference() {
        when(subMultipleRefBristolRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceBristol);
    ...
    public void createWalesReference() {
        when(subMultipleRefWalesRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceWales);
    ...
    public void createNewcastleReference() {
        when(subMultipleRefNewcastleRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceNewcastle);
    ...
    public void createWatfordReference() {
        when(subMultipleRefWatfordRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceWatford);
    ...
    public void createLondonCentralReference() {
        when(subMultipleRefLondonCentralRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceLondonCentral);
    ...
    public void createLondonSouthReference() {
        when(subMultipleRefLondonSouthRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceLondonSouth);
    ...
    public void createLondonEastReference() {
        when(subMultipleRefLondonEastRepository.findTopByRefContainsOrderByMultipleRefDesc()).thenReturn(referenceLondonEast);
