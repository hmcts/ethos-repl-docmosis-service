...
public class ReferenceServiceTest {
    ...
    public void fetchHearingVenueRefDataWithThreeVenuesPresent() throws IOException {
        String result = "CaseData(tribunalCorrespondenceAddress=null, "
                ...
                + "linkedCaseCT=null, stateAPI=null, testDynamicListCollection=null)";
    ...
    public void fetchHearingVenueRefDataWithNoVenuesRefData() throws IOException {
        String result = "CaseData(tribunalCorrespondenceAddress=null, " +
                ...
                + "positionTypeCT=null, linkedCaseCT=null, stateAPI=null, testDynamicListCollection=null)";
    ...
    public void fetchHearingVenueRefDataWithNoReferenceData() throws IOException {
        String result = "CaseData(tribunalCorrespondenceAddress=null, " +
                ...
                "hearingTimingDuration=null, companyPremises=null, officeCT=null, reasonForCT=null, relatedCaseCT=null, positionTypeCT=null, linkedCaseCT=null, stateAPI=null, testDynamicListCollection=null)";
