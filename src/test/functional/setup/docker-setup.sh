...
../../../../../ccd-docker/bin/ccd-import-definition.sh src/test/functional/resources/config/CCD_EmpTrib_Manc_v1.0.13.xlsx
...
../../../../../ccd-docker/bin/ccd-import-definition.sh src/test/functional/resources/config/CCD_EmpTrib_Glas_v1.0.13.xlsx
