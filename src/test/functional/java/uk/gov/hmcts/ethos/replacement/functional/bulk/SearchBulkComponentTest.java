...
public class SearchBulkComponentTest {
    ...
    @Test
    public void search_bulk_eng_company_claimant_represented() throws IOException {
        testUtil.executeSearchBulkTest(false, Constants.TEST_DATA_ENG_BULK1);
    }
    ...
    @Test
    public void search_bulk_eng_all_cases_invalid() throws IOException {
        testUtil.executeSearchBulkTest(false, Constants.TEST_DATA_ENG_BULK1);
    }
    ...
    @Test
    public void search_bulk_scot_company_claimant_represented() throws IOException {
        testUtil.executeSearchBulkTest(false, Constants.TEST_DATA_SCOT_BULK1);
    }
    ...
    public void search_bulk_with_no_payload() throws IOException {
        ...
        Response response = testUtil.getResponse(ccdRequest, Constants.SEARCH_BULK_URI, 400);
    ...
    public void search_bulk_with_no_token() throws IOException {
        ...
        Response response = testUtil.getResponse(ccdRequest, Constants.SEARCH_BULK_URI, 401);
