...
public class UpdateCaseBulkComponentTest {
    ...
    public void update_bulk_case_with_no_payload() throws IOException {
        ...
        Response response = testUtil.getResponse(ccdRequest, Constants.UPDATE_BULK_CASE_URI, 400);
    ...
    public void update_bulk_case_with_no_token() throws IOException {
        ...
        Response response = testUtil.getResponse(ccdRequest, Constants.UPDATE_BULK_CASE_URI, 401);
